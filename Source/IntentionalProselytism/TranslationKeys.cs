...
{
    public const string ModVersion = "IntentionalProselytism.ModVersion";
    public const string ChooseIdeo = "IntentionalProselytism.ChooseIdeo";
    public const string RemoveCurrentIdeo = "IntentionalProselytism.RemoveCurrentIdeo";
